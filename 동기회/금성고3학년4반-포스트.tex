...
%	------------------------------------------------------------------------------ 제목
	...
	\author{ 	작성 : 2022년 8월 19일 금요일 수정 : 2022년 8월 19일 금요일 }
...
%	------------------------------------------------------------------------------ 악기
			\block{■  2022년 여름 야유회  }
			{
				...
				\begin{LARGE}
					\begin{itemize}
					\item 일시 ; 2022년 8월 21일 일요일
					\item 장소 : 울산 울주군 상북면 소호로 431 번지 천명효 선배
					\item 인원 : 김대희 신인재 양천을 김태형 조성호 김승민 한영만 주보선 강은철 9명
					\item 준비물 : 
